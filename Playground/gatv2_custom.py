...
from gatv2conv_gpu import GATv2Conv_GPU

__all__ = ["GATv2_custom"]

# pylint: disable=W0221
class GATv2Layer_custom(nn.Module):
    ...
    def __init__(
        ...
        super(GATv2Layer_custom, self).__init__()
        self.gatv2_conv = GATv2Conv_GPU(
            in_feats=in_feats,
            out_feats=out_feats,
            num_heads=num_heads,
            feat_drop=feat_drop,
...
class GATv2_custom(nn.Module):
    ...
    def __init__(
        ...
        super(GATv2_custom, self).__init__()
