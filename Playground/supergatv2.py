...
from supergatv2conv import SuperGATv2Conv

__all__ = ["SuperGATv2"]

class SuperGATv2Layer(nn.Module):
    ...
    def __init__(
        ...
        super(SuperGATv2Layer, self).__init__()
        self.gatv2_conv = SuperGATv2Conv(
            in_feats=in_feats,
            out_feats=out_feats,
            num_heads=num_heads,
            feat_drop=feat_drop,
...
class SuperGATv2(nn.Module):
    ...
    def __init__(
        ...
        super(SuperGATv2, self).__init__()
