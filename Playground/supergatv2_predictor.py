...
class SuperGATv2Predictor(nn.Module):
    ...
    def __init__(
            ...
            predictor_dropout=0.):
        super(SuperGATv2Predictor, self).__init__()

        self.gnn = SuperGATv2(in_feats=in_feats,
        ...
        # self.predict = MLPPredictor(gnn_out_feats, predictor_out_feats, n_tasks, predictor_dropout)
        self.predict = MLPPredictor(2 * gnn_out_feats, predictor_out_feats, 12, predictor_dropout)
        pass
